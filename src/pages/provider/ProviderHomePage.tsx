          ...
          <header className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <h1 className="mt-2 text-3xl font-bold text-brand-900">Dashboard administrativo</h1>
                <p className="mt-2 text-sm leading-6 text-slate-600">
                  Visão geral dos atendimentos salvos no LocalStorage.
                </p>
              </div>
              <div className="flex items-center gap-3 rounded-lg bg-slate-50 p-3">
                <div className="flex h-11 w-11 items-center justify-center rounded-lg bg-brand-800 text-white">
                  <ShieldCheck className="h-5 w-5" aria-hidden="true" />
                </div>
                <div>
                  <p className="text-xs font-semibold uppercase tracking-wide text-slate-500">Perfil</p>
                  <p className="font-bold text-brand-900">Administrador</p>
                </div>
              </div>
            </div>
          </header>
